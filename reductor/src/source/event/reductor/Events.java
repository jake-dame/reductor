...
public class Events {
    ...
    final ArrayList<SetTempoEvent> setTempoEvents = new ArrayList<>();
    final ArrayList<KeySignatureEvent> keySignatureEvents = new ArrayList<>();
    final ArrayList<TimeSignatureEvent> timeSignatureEvents = new ArrayList<>();

    // Channel events
    final ArrayList<NoteOnEvent> noteOnEvents = new ArrayList<>();
    final ArrayList<NoteOffEvent> noteOffEvents = new ArrayList<>();
