...
public enum MessageType {
    ...
    public static MessageType getEnumType(int messageTypeOrCommandValue) {
        ...
        throw new RuntimeException("New message type that is not currently in enum: " + Integer.toHexString(messageTypeOrCommandValue));
    ...
    public String toString() {
        ...
        return this + " (0x" + Integer.toHexString(this.statusCode) + ")"; // todo this vs this.name() (see doc)
