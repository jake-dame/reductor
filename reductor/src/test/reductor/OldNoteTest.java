...
//import static reductor.ReductorUtil.midiEventsToNotes;
//
//
//class OldNoteTest {
//
...
//        assertEquals(original.stop, copy.stop);
...
//
//        i = 1
//        note low = 100 event = 2
//        note end = 200 = event = 3
//
//        ...
//
//        i = 4
//        note low = 400 event = 8
...
//
//            assertEquals(note.start, events.get(j++).getTick());
//            assertEquals(note.stop, events.get(j++).getTick());
//        }
//
//    }
//
