...
class PieceTest {
    ...
    DevelopmentHelper dh;

    @BeforeEach
    void setUp() {
        dh = new DevelopmentHelper();
    }
    ...
    void gettingMeasuresPieceNoPickup() throws InvalidMidiDataException, UnpairedNoteException {
         ...
         */
        Piece piece = dh.getPiece(CHOPIN_PREL_c);
    ...
    void pseudoPickupTest() throws InvalidMidiDataException, UnpairedNoteException {
        ...
        Piece piece = dh.getPiece(PSEUDO_ANACRUSIS_TEST);
    ...
    void getMeasureRanges() throws InvalidMidiDataException, UnpairedNoteException {
        ...
        */
        ...
        Piece piece = dh.getPiece(MEASURE_SIZE_TEST);
