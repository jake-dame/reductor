...
class RhythmTest {
    ...
    void testEnumBases() {
        ...
        assertEquals(RhythmType.WHOLE, RhythmType.getEnumType(1920, RES));
        assertEquals(RhythmType.HALF, RhythmType.getEnumType(960, RES));
    ...
    void testBasicRhythmValues() {
        ...
        Rhythm r1 = new Rhythm(480, RES); // quarter
        Rhythm r2 = new Rhythm(720, RES); // dotted quarter

        Rhythm r3 = new Rhythm(240, RES); // eighth
        Rhythm r4 = new Rhythm(360, RES); // dotted eighth
        Rhythm r5 = new Rhythm(160, RES); // triplet eighth

        Rhythm r6 = new Rhythm(10000, RES); // tied whole
