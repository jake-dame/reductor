...
public class Bucket extends AbstractList<Note> implements Noted {
    ...
    @Override
    public void addFirst(Note note) { this.notes.addFirst(note); }
    @Override
    public void addLast(Note note) { this.notes.addLast(note); }
    @Override
    ...
    @Override
    public boolean remove(Object note) { return this.notes.remove(note); }
    @Override
    public Note removeFirst() { return this.notes.removeFirst(); }
    @Override
    public Note removeLast() { return this.notes.removeLast(); }


    @Override
    public void sort(Comparator<? super Note> c) { this.notes.sort(c); }

    @Override
    public void forEach(Consumer<? super Note> action) { this.notes.forEach(action); }

    @Override
    public Iterator<Note> iterator() { return this.notes.iterator(); }
