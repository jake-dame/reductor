...
//
//
//// Chord is a convenience structure,
...
//
//    /**
//     * Since this is used for startAfter() capabilities, but can also be used to reduce creation
//     * tax if multiple
//     * chords are similar, the other Chord's notes are ALSO retained, since this must act like a
//     * copy constructor.
//     * If more notes are added with add(), they will be added to this Chord's notes, along with
//     * the previous Chord's
//     * notes. To start fresh in terms of notes, but retain the timing-chaining properties, make a
//     * call to the clear
...
//        }
//
//        public ChordBuilder rhythm(RhythmTypeAlpha type) {
...
//                this.stop = null; // nullify the stop, force user to set it or it will be given
//                // default later
//            }
//            return this;
//        }
...
//            for (String pitch : pitches) { this.pitches.add(PitchUtil.toInt(pitch)); }
//            return this;
//        }
//
//        public Chord build() {
...
//
//            if (stop == null) {
//                if (rhythm == null) { this.stop = this.start + 479L; } else {
...
//
//            /* Chords are designed so that every Note contained within (as well as the Chord
//            itself) have the same
//            range and rhythm. Therefore, the actual Note objects cannot be constructed until this
//             point. */
//            ArrayList<Note> notes = new ArrayList<>();
//
//            if (prevNotes != null) {
//                for (Note note : prevNotes) {
//                    this.pitches.add(note.getPitch());
//                }
//            }
//
...
//    // This doesn't alter any notes, it just changes the order of the notes in this Chord's
//    // container.
...
//
//            while (inversions != 0) {
//                if (notes.peekFirst().getPitch() + 12 <= MAX_PIANO) {
...
//
//            while (inversions != 0) {
//                if (MIN_PIANO <= notes.peekLast().getPitch() - 12) {
...
//        if (inversion < 0 || 2 < inversion) {
//            throw new RuntimeException("invalid inversion: " + inversion);
//        }
//
...
//        in.sort(Comparator.comparingInt(Note::getPitch));
//
