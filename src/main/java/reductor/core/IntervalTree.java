...
/**
 * An interval tree (augmented BST) that can contain any object with a {@link Range}
 * (i.e., implements the {@link Ranged} interface), e.g. {@link Note}, {@link Column}, etc.
 * <p>
...
public class IntervalTree<T extends Ranged> {
    ...
    */
    ...
    public class Node implements Ranged {
        ...
        /// Primary constructor which takes a {@link Range}
        Node(Range range) {
    ...
    /// Primary constructor
    public IntervalTree(ArrayList<T> elements) {
