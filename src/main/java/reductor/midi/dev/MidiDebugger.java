...
public class MidiDebugger {
    ...
    static void main(String[] args) throws InvalidMidiDataException, IOException {

        Sequence seq = MidiSystem.getSequence(new File("musicxml_test.mid"));
